...
def main():
	...
	p.add_argument('-A', '--adj', type=str, default='adjacency_US_BS2')  # name of the network
	# p.add_argument('-l', '--label', type=str, default='500_3_20.0_0.1_True_1')  # name of the network
	# p.add_argument('-f', '--in_folder', type=str, default='../data/input/synthetic/node_anomalies/')  # path of the input network
	p.add_argument('-f', '--in_folder', type=str, default='../data/input/RD/')  # path of the input network
	p.add_argument('-o', '--out_folder', type=str, default='../data/output/5-fold_cv/RD/')  # path to store outputs
	...
	label = args.adj
	network = args.in_folder+label+'.dat'
	...
	for fold in range(NFold):
		...
		comparison[11], comparison[12] = 0.,0.
		...
		comparison[13], comparison[14] = 0.,0.
